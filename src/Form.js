        ...
        <header className="App-header">
          ...
          <div className={"stepDiv"}>
            <Steps direction={'vertical'} current={countNumber}>
              ...
              <Step className={'steps'} title="سوشل میڈیا اکاؤنٹ" description="" />
              ...
              <Step className={'steps'} title="دیگر پیشہ ورانہ صلاحیت" description="" />
              <Step className={'steps'} title="دارالافتاء کے علاوہ مصروفیات" description="" />
              ...
              <Step className={'steps'} title="تنظیمی ذمہ داری" description="" />
              ...
              countNumber === 0 ?
                <div className={'counter'}>
                  ...
                  <div className='header inputrow'>
                    ...
                    <CustomInput onChange={(e) => this.onchangetext('Father-ولدیت', e.target.value, 'personalInfo', 1)} title={'Father-ولدیت'} />
                    <CustomInput onChange={(e) => this.onchangetext('Name-نام', e.target.value, 'personalInfo', 1)} title={'Name-نام'} />
                  </div>
                  <div className='header inputrow'>
                    <CustomInput onChange={(e) => this.onchangetext('Nationality -قومیت', e.target.value, 'personalInfo', 2)} title={'Nationality -قومیت'} />
                    <CustomInput onChange={(e) => this.onchangetext('Date of Birth- تاریخ پیدائش', e.target.value, 'personalInfo', 2)} title={'Date of Birth- تاریخ پیدائش'} type={'date'} />
                  </div>
                  <div className='header inputrow'>
                    <CustomInput onChange={(e) => this.onchangetext('Passport No - پاسپورٹ نمبر', e.target.value, 'personalInfo', 3)} title={'Passport No. - پاسپورٹ نمبر'} type={'number'} />
                    <CustomInput onChange={(e) => this.onchangetext('NIC-ID -شناختی کارڈ نمبر آئی ڈی', e.target.value, 'personalInfo', 3)} title={'NIC/ID -شناختی کارڈ نمبر/  آئی ڈی '} type={'number'} />
                  </div>
                  <div className='header inputrow'>
                    <CustomInput onChange={(e) => this.onchangetext('PTCL-پی ٹی سی ایل نمبر', e.target.value, 'personalInfo', 4)} title={'PTCL-پی ٹی سی ایل نمبر'} type={'number'} />
                    <CustomInput onChange={(e) => this.onchangetext('Mobile No -موبائل نمبر', e.target.value, 'personalInfo', 4)} title={'Mobile No. -موبائل نمبر'} type={'number'} />
                  </div>
                  <div className='header inputrow'>
                    <CustomInput onChange={(e) => this.onchangetext('Chronic Disease - دائمی مرض', e.target.value, 'personalInfo', 5)} title={'Chronic Disease - دائمی مرض'} />
                    <div className='inputrowchild' >
                      <span className={'inputHeading'}>Blood Group - بلڈ گروپ</span> <br />
                      <Select className='input dropdown' defaultValue="A+" onChange={(value) => this.onchangetext('Blood Group - بلڈ گروپ', value, 'personalInfo', 5)} >
                        <Option value="A+">A+</Option>
                        <Option value="A-">A-</Option>
                        <Option value="B+">B+</Option>
                        <Option value="B-">B-</Option>
                  ...
                  <div className='header inputrow'>
                    ...
                    <CustomInput onChange={(e) => this.onchangetext('Emergency No - ایمرجنسی نمبر', e.target.value, 'personalInfo', 6)} title={'Emergency No. - ایمرجنسی نمبر'} type={'number'} />
                  </div>
                  <div className='header inputrow'>
                    <div className='inputrowchild' >
                    </div>
                    <CustomInput onChange={(e) => this.onchangetext('E-mail-ای میل', e.target.value, 'personalInfo', 7)} title={'E-mail - ای میل'} />
                  </div>
                  <div className='header inputrow'>
                    <div className='inputrowchild' >
              ...
              countNumber === 1 ?
                <div className={'counter'}>
                  ...
                  <div className='header inputrow accounts'>
                    <CustomInput className={"social"} onChange={(e) => this.onchangetext('Facebook', e.target.value, 'socialMedia', 0)} title={'Facebook'} />
                    <CustomInput className={"social"} onChange={(e) => this.onchangetext('Whatsapp', e.target.value, 'socialMedia', 0)} title={'Whatsapp '} />
                  </div>
                  <div className='header inputrow accounts'>
                    <CustomInput className={"social"} onChange={(e) => this.onchangetext('Twitter', e.target.value, 'socialMedia', 1)} title={'Twitter'} />
                    <CustomInput className={"social"} onChange={(e) => this.onchangetext('Skype', e.target.value, 'socialMedia', 0)} title={'Skype '} />
                  </div>
                  <div className='header inputrow accounts'>
                    <CustomInput className={"social"} onChange={(e) => this.onchangetext('Instagram', e.target.value, 'socialMedia', 1)} title={'Instagram'} />
                    <CustomInput className={"social"} onChange={(e) => this.onchangetext('LinkedIn', e.target.value, 'socialMedia', 1)} title={'Linked In '} />
                  </div>
                </div> : null
            }
                ...
                <div className={'counter'}>
                  ...
                  <div id={'address'}>
                    <div className='header inputrow accounts'>
                      <div className='inputrowchild' >
                        ...
                        <Select className='input dropdown' defaultValue="سندھ"
                          onChange={(value) => this.onchangetext('سرکاری صوبہ', value, 'address', 1)}
                        >
                  ...
                  <div className='header inputrow accounts'>
                    ...
                    <div className='inputrowchild' >
                      ...
                      <Select className='input dropdown' defaultValue="ذاتی"
                        onChange={(value) => this.onchangetext('مکان کی حیثیت', value, 'address', 1)}
                      >
                ...
                <table>
                  ...
                  </tr>
                  {
                    skillsArr.map((data, index) =>
                      <tr>
                        <td ><Duration onChange={(value) => this.handleArrayChange(value, index, 'years', 'skillsArr')} /></td>
                        <td ><GradeDropDown onChange={(value) => this.handleArrayChange(value, index, 'grade', 'skillsArr')} /></td>
                        <td >
                          <Input
                ...
                <div style={{ width: '90%' }}>
                  <table className={'skills'}>
                    ...
                    <tr>
                      ...
                      <td><YesnoDropDown
                        onChange={(value) => this.onchangetext('امامت', value, 'outOfDarulifta', 0)} /></td>
                    ...
                    <tr>
                      ...
                      <td><Input
                        ...
                        className={'tableInput'} type={'text'} /></td>
                      <td><YesnoDropDown
                        onChange={(value) => this.onchangetext('مؤذنی', value, 'outOfDarulifta', 1)} /></td>
                    ...
                    <tr>
                      ...
                      <td><Input
                        ...
                        className={'tableInput'} type={'text'} /></td>
                      <td><YesnoDropDown
                        onChange={(value) => this.onchangetext('جامعۃ المدینہ میں تدریس', value, 'outOfDarulifta', 2)} /></td>
                    ...
                    <tr>
                      ...
                      <td><Input
                        ...
                        className={'tableInput'} type={'text'} /></td>
                      <td> <YesnoDropDown
                        onChange={(value) => this.onchangetext('خطابت', value, 'outOfDarulifta', 3)} /></td>
                      <th style={{ padding: 4, paddingRight: 12, paddingLeft: 12 }}>خطابت</th>
                    </tr>
                    <tr>
                      <td colSpan={3}><TextArea style={{ textAlign: 'right' }}
                        onChange={(e) => this.onchangetext('دیگر(کاروباری یا علاوہ)', e.target.value, 'outOfDarulifta', 4)}
                        rows={4} /></td>
                  ...
                  <div className={"textArea"}>
                    <TextArea onChange={(e) => this.setState({ writtenWork: e.target.value })}
                      style={{ textAlign: 'right' }} rows={4} />
                  </div>
                </div>
              </div> : null}
            {
                  ...
                  <div className={"table-div"}>
                    <table className={'skills'}>
                      ...
                      <tr>
                        ...
                        <td> <YesnoDropDown
                          onChange={(value) => {
                            this.onchangetext('مطالعہ کی عادت ہے؟', value, 'reading', 0)
                          }}
                        /></td>
                      </tr>
                      <tr>
                        <td colSpan={'3'}>
                          <Select
                            ...
                            defaultValue={['Urdu',]}
                            onChange={(value) => {
                              this.onchangetext('کس کس زبان میں مطالعہ کرتے ہیں؟', value, 'reading', 1)
                              console.log(value)
                            }}
                            style={{ width: '100%' }}
                          >
                  ...
                  <div className={"table-div"} >
                    <table>
                      ...
                      <tr>
                        ...
                        <td> <YesnoDropDown
                          onChange={(value) => this.onchangetext('ہفتہ وار اجتماع میں بیان کرتے ہیں؟', value, 'speeches', 0)}
                        /></td>
                        <td> <YesnoDropDown
                          onChange={(value) => this.onchangetext('کیا بیانات کرتے ہیں؟', value, 'speeches', 0)}
                        /></td>
                      </tr>
                      <tr>
                        <td> <Input
                ...
                <div>
                  <div className={"table-div"} >
                    <table>
                      ...
                      <tr>
                        <td colSpan={'6'}> <Input
                          onChange={(e) => this.handleArrayChange(e.target.value, 0, 'Mother Tongue - مادری زبان', 'languageArr')}
                          className={'tableInput'} /></td>
                          ...
                          return (
                            index !== 0 ?
                              <tr key={index}>
                                <td style={{ width: 80 }}>
                                  <Select className={"tdSelect"}
                                    onChange={(value) => this.handleArrayChange(value, index, 'curr', 'languageArr')}
                                    name="گروپ"
                                    defaultValue={"بہتر"} >
                                    {
                                      data.current.map((data) => <Option value={data}>{data}</Option>)
                                    }
                                  </Select>
                                </td>
                                <td><Input
                                  onChange={(e) => this.handleArrayChange(e.target.value, index, 'howMuch', 'languageArr')}
                                  className={'tableInput'} type={'text'} /></td>
                                <td><Input
                                  onChange={(e) => this.handleArrayChange(e.target.value, index, 'where', 'languageArr')}
                                  className={'tableInput'} type={'text'} /></td>
                                <td> <Checkbox
                                  onChange={(value) => this.handleArrayChange(!data.understand, index, 'understand', 'languageArr')}
                                  value={data.understand} /></td>
                                <td> <Checkbox
                                  onChange={(value) => this.handleArrayChange(!data.speak, index, 'speak', 'languageArr')}
                                  value={data.speak} /></td>
                                <td> <Checkbox
                                  onChange={(value) => this.handleArrayChange(!data.write, index, 'write', 'languageArr')}
                                  value={data.write} /></td>
                                <td> <Checkbox
                                  onChange={(value) => this.handleArrayChange(!data.read, index, 'read', 'languageArr')}
                                  value={data.read} /></td>
                                <td> <Checkbox
                                  onChange={(value) => this.handleArrayChange(!data.accent, index, 'accent', 'languageArr')}
                                  value={data.accent} /></td>
                                <td>{data.name}</td>
                              </tr> : null
                          )
                        })
              ...
              countNumber === 11 ?
                <div>
                  <div className={"table-div"}>
                    <table>
                      <tr>
                        <td className={'tableHeading'} colSpan={'4'}>تنظیمی ذمہ داری</td>
                      </tr>
                      <tr>
                        <td >مقام</td>
                        <td >عرصہ ذمہ داری</td>
                      ...
                      <tr>
                        <td><Input
                          onChange={(e) => this.onchangetext('مقام', e.target.value, 'tanzeemWork', 0)}
                          className={'tableInput'} type={'text'} /> </td>
                        <td> <Input
                          onChange={(e) => this.onchangetext('عرصہ ذمہ داری', e.target.value, 'tanzeemWork', 0)}
                          className={'tableInput'} type={'number'} /> </td>
                        <td><Select
                      ...
                      <tr>
                        <td><Input
                          onChange={(e) => this.onchangetext('مقام', e.target.value, 'tanzeemWork', 1)}
                          className={'tableInput'} type={'text'} /> </td>
                        <td> <Input
                        ...
                        outOfCountry.map((data, index) => {
                          ...
                          return (
                            <tr>
                              ...
                              <td> <Input
                                onChange={(e) => this.onchangetext(keys[3], e.target.value, 'outOfCountry', index)}
                                className={'tableInput'} type={'text'} /></td>
                              <td> <Input
                                onChange={(e) => this.onchangetext(keys[2], e.target.value, 'outOfCountry', index)}
                                className={'tableInput'} type={'text'} /></td>
                              <td> <Input
                                onChange={(e) => this.onchangetext(keys[1], e.target.value, 'outOfCountry', index)}
                                className={'tableInput'} type={'text'} /></td>
                              <td>  <Input
                                onChange={(e) => this.onchangetext(keys[0], e.target.value, 'outOfCountry', index)}
                                className={'tableInput'} type={'text'} /></td>
                              <td>1</td>
                            </tr>
                          )
